...
building blocks for the BST, AVLTree, and Heap data structures
implemented correctly to be able to implement the other data structures.
'''
...
class Node():
    ...
    Given a node t, visualize the node running str(t) in the python
...
class BinaryTree():
    ...
    def __init__(self, root=None):
        ...
        ordinary BinaryTree, we cannot insert more than one element,
    ...
    def print_tree(self, traversal_type):
        ...
        All traversals are implemented for you as a reference
        '''
        if traversal_type == 'preorder':
            ...
            s = str(traversal_type)
            raise ValueError('Traversal type ' + s + ' is not supported.')
    ...
    def to_list(self, traversal_type):
        ...
        we can always print the returned results to visualize them.
        by returning the results we can do more computations on the results
        complicated tree functions rely on this to_list function,
    ...
    def __len__helper(node):
        ...
        if a left child exists, add the
        result of __len__helper on the left child;
        if a right child exists, add the
        result of __len__helper on the right child;
    ...
    def height(self):
        ...
        the height is the maximum length from the root to a leaf node.
